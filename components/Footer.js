      ...
      <div className="footer-inner">
        <div className="footer-brand">
          ...
          <div className="footer-socials">
            ...
            <a href="https://t.me/toosiitech" target="_blank" rel="noopener noreferrer" aria-label="Telegram" title="Telegram">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221l-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.447 1.394c-.16.16-.295.295-.605.295l.213-3.053 5.56-5.023c.242-.213-.054-.333-.373-.12L7.17 13.67l-2.95-.924c-.642-.204-.657-.642.136-.953l11.57-4.461c.537-.194 1.006.131.968.889z"/></svg>
            </a>
            <a href="https://twitter.com/austin254ke" target="_blank" rel="noopener noreferrer" aria-label="Twitter" title="Twitter/X">
            ...
            <a href="https://www.facebook.com/ToosiiGrainger.com9" target="_blank" rel="noopener noreferrer" aria-label="Facebook" title="Facebook">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            <a href="https://instagram.com/toosii_ke" target="_blank" rel="noopener noreferrer" aria-label="Instagram" title="Instagram">
            ...
            <a href="https://wa.me/254748340864" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" title="WhatsApp">
        ...
        <div className="footer-links">
          ...
          <ul>
            ...
            <li><Link href="/tools/movies">ToosiiFlix</Link></li>
