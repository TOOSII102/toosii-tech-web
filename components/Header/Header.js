...
const toolsNav = [
  ...
  { href: '/tools/imagine',       icon: '🎨', label: 'AI Image Generator', desc: 'Text to stunning images' },
  { href: '/tools/remove-bg',     icon: '✂️', label: 'Background Remover', desc: 'Transparent PNG cutouts' },
  { href: '/tools/lyrics',        icon: '🎶', label: 'Lyrics Finder',      desc: 'Full song lyrics fast' },
