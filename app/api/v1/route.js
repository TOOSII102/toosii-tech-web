...
const endpoints = [
  ...
  { method: 'POST', path: '/api/tools/imagine', category: 'AI', description: 'Generate an AI image from a text description (text-to-image).' },
  { method: 'POST', path: '/api/tools/remove-bg', category: 'Tools', description: 'Remove the background from an uploaded image and return a transparent PNG.' },
  { method: 'GET', path: '/api/tools/lyrics?q=jeje', category: 'Media', description: 'Look up full song lyrics by title or artist.' },
