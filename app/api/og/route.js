...
function pageFor(path, searchParams = new URLSearchParams()) {
  ...
  if (path.startsWith('/tools/imagine')) return { eyebrow: 'AI IMAGE GENERATOR', title: 'Type it. See it.', description: 'Describe anything and get a stunning AI-generated image in seconds — free, no watermark.', accent: '#a78bfa', secondary: '#f472b6', chips: ['Text to Image', 'HD Quality', 'Free'], layout: 'tool' }
  if (path.startsWith('/tools/remove-bg')) return { eyebrow: 'BACKGROUND REMOVER', title: 'Clean cutouts, one tap.', description: 'Upload a photo and get a crisp transparent PNG in seconds.', accent: '#22d3ee', secondary: '#72f0ba', chips: ['Transparent PNG', 'No Sign-up', 'Free'], layout: 'tool' }
  if (path.startsWith('/tools/lyrics')) return { eyebrow: 'LYRICS FINDER', title: 'Every word, sing along.', description: 'Full lyrics for any song — Bongo, Afrobeats, Gengetone and more.', accent: '#4ade80', secondary: '#75d6ff', chips: ['Full Lyrics', 'Any Song', 'Free'], layout: 'tool' }
