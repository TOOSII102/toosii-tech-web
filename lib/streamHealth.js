...
const TTL_OK_MS = 15 * 60 * 1000   // trust a good result for 15 min
const TTL_BAD_MS = 5 * 60 * 1000   // re-test failures sooner, they may recover
...
function cached(url) {
  ...
  const ttl = hit.ok ? TTL_OK_MS : TTL_BAD_MS
